...
public final class EditProfileBinding implements ViewBinding {
  ...
  @NonNull
  public final AppCompatButton cencel;
  ...
  private EditProfileBinding(@NonNull ConstraintLayout rootView, @NonNull AppCompatButton cencel,
      @NonNull EditText editName, @NonNull EditText editPhone, @NonNull TextView textView9,
  ...
  public static EditProfileBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.cencel;
      AppCompatButton cencel = ViewBindings.findChildViewById(rootView, id);
      if (cencel == null) {
        break missingId;
      }
      ...
      return new EditProfileBinding((ConstraintLayout) rootView, cencel, editName, editPhone,
          textView9, update);
    }
